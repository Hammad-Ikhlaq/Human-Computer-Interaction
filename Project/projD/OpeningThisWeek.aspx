<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpeningThisWeek.aspx.cs" Inherits="proj.OpeningThisWeek" %>
...
<script type="text/javascript">
			...
			<div class="agile_wthree_nav">
				<nav class="navbar navbar-default">
			      ...
			      <ul class="nav navbar-nav">
                           ...
                           <li class="active"><a href="OpeningThisWeek.aspx">Opening This Week</a></li>
	...
	<div class="banner_bottom_w3ls_agile">
		<div class="banner_bottom_w3ls_info">
            <h3 class="agile_heading">Opening This Week</h3>
			<p>    <br /><br />
