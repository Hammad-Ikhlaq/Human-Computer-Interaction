<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DLW.aspx.cs" Inherits="proj.DLW" %>
...
<body>
	...
	<div class="banner_bottom_w3ls_agile">
		<div class="banner_bottom_w3ls_info">
            <h3 class="agile_heading">Delete Lists</h3>
			<p> 
         <asp:PlaceHolder  runat="server" ID="pl"></asp:PlaceHolder>
            <br /><br />
            <button class="bb2" id="Op" Visible="false" runat="server">Click To Add Options</button>
