<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MKW.aspx.cs" Inherits="proj.MKW" %>
...
<body>
	...
	<div class="banner_bottom_w3ls_agile">
		<div class="banner_bottom_w3ls_info">
            <h3 class="agile_heading">Creating a New WatchList</h3>
			
Name of List:              <asp:TextBox ID="Name" runat="server"></asp:TextBox>
        <br /><br />
     

        <asp:Button  class="bb2" ID="CL" runat="server" Text="Create List" 
          onclick="MKW_Click" />
           <br /><br />
