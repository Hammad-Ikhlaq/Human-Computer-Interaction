<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Polls.aspx.cs" Inherits="proj.Polls" %>
...
<body>
    ...
    <div class="inner_agile_pages">
       ...
       <li ><a href="Details.aspx">Coming Soon</a></li>
	...
	<div class="banner_bottom_w3ls_agile">
		<div class="banner_bottom_w3ls_info">
            <h3 class="agile_heading">Polls</h3>
			<p>      <br /><br />
                           <button class="bb2" id="MakeP"  OnServerClick="MakePoll" runat="server">Click Here to Make a new Poll</button>
                   <br /><br />
                               <button class="bb2" id="VoteP" OnServerClick="VotePoll" runat="server">Click Here to Vote in Polls</button>
