<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakePoll.aspx.cs" Inherits="proj.WebForm7" %>
...
<body>
			...
			<div class="agile_wthree_nav">
				<nav class="navbar navbar-default">
			      ...
			      <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="Polls.aspx">Polls</a></li>
                           <li><a href="WatchList.aspx">watchList</a></li>
	...
	<div class="banner_bottom_w3ls_agile">
		<div class="banner_bottom_w3ls_info">
            <h3 class="agile_heading">Making Polls</h3>
			<p>    <br /><br />
                           Enter Name of Poll:      <asp:TextBox ID="PName" runat="server"></asp:TextBox>
                   <br /><br />
                           Enter No of Options:              <asp:TextBox ID="NO" runat="server"></asp:TextBox>
                               <br /><br />
                           <button class="bb2" id="Mp" OnServerClick="MakePoll" runat="server">Click To make Poll</button>
                                         <asp:Label ID="Message" runat="server" />
         <asp:PlaceHolder  runat="server" ID="pl"></asp:PlaceHolder>
            <br /><br />
            <button class="bb2" id="Op" Visible="false" OnServerClick="AO" runat="server">Click To Add Options</button>
